...
**V0.9 — Capability-Isolated Execution and Real Effect Adapters**, with remaining integration acceptance tracked separately. V0.4–V0.8 do not retroactively complete V0.3 live acceptance. V0.8 measures local designed fixtures, not production reliability.
...
5. Move effect-aware trials into an actual container boundary with a network-deny default, scoped mounts, scoped credentials, and explicit provider capabilities. Preserve the V0.8 prepare/commit boundary.
